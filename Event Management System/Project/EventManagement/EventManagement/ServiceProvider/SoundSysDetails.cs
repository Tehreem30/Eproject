...
{
    public partial class SoundSysDetails : UserControl
    {
        public SoundSysDetails()
        {
            InitializeComponent();
        }
        ...
        private void SoundSysDetails_Load(object sender, EventArgs e)
        {
            textBox4.Text = "Sound System";
            string conx = connectionclass.ConnectionString;
            SqlConnection con = new SqlConnection(conx);
            try
            {
