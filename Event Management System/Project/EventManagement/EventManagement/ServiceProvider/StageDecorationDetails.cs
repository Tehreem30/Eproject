...
{
    public partial class StageDecorationDetails : UserControl
    {
        public StageDecorationDetails()
        {
            InitializeComponent();
        }
        ...
        private void StageDecorationDetails_Load(object sender, EventArgs e)
        {
            textBox4.Text = "Stage Decoration";
            string conx = connectionclass.ConnectionString;
            SqlConnection con = new SqlConnection(conx);
            try
            {
